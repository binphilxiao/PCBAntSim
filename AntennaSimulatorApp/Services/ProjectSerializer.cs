    ...
    public static class ProjectSerializer
    {
        ...
        private static AntennaParamsDto AntennaToDto(AntennaParams a)
        {
            var dto = new AntennaParamsDto
            {
                ...
                OffsetX       = a.OffsetX,
                OffsetY       = a.OffsetY,
                HasGroundStub = a.HasGroundStub,
                MirrorEnabled = a.MirrorEnabled,
                MirrorAxis    = a.MirrorAxis,
                FreqGHz       = a.FreqGHz,
                LengthL       = a.LengthL,
                HeightH       = a.HeightH,
                FeedGap       = a.FeedGap,
        ...
        private static AntennaParams DtoToAntenna(AntennaParamsDto dto)
        {
            ...
            var ap = new AntennaParams
            {
                ...
                OffsetX       = dto.OffsetX,
                OffsetY       = dto.OffsetY,
                HasGroundStub = dto.HasGroundStub,
                MirrorEnabled = dto.MirrorEnabled,
                MirrorAxis    = dto.MirrorAxis,
                FreqGHz       = dto.FreqGHz,
                LengthL       = dto.LengthL,
                HeightH       = dto.HeightH,
                FeedGap       = dto.FeedGap,
